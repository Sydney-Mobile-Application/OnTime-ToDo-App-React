...
const email = "ontimetodoapp@gmail.com";
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.helpSupportDetail}>
          <TouchableOpacity
            style={styles.helpSupportContainer}
            onPress={() => {
              Linking.openURL(
                "mailto:ontimeapp@gmail.com?subject=OnTime To Do App&body=Hi, ToDoApp's Team!"
              );
            }}
          >
            <View style={styles.helpDetail}>
              <Text style={{ marginRight: "5%" }}>
                <MaterialIcons name="email" size={25} color="#293462" />
              </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Linking.openURL(
                `whatsapp://send?text=Hi, ToDoApp's Team!&phone=${phoneNumber}`
              );
            }}
          >
            <View style={styles.helpDetail}>
              <Text style={{ marginRight: "5%" }}>
                <MaterialIcons name="phone" size={25} color="#293462" />
              </Text>
